...
public class FileChooser extends javax.swing.JFrame
{
    ...
    public FileChooser(String encryptOrDecrypt)
    {
        ...
        initComponents();
        jFileChooser1.setDialogTitle("Seleccione los archivos y las carpetas que desea encriptar "+encryptOrDecrypt);
        ...
        if(encryptOrDecrypt.equalsIgnoreCase("encrypt"))
        {
            ...
            UIManager.put("FileChooser.openButtonText", "Seleccionar archivos");
        }
        else if(encryptOrDecrypt.equalsIgnoreCase("decrypt"))
        {
            UIManager.put("FileChooser.openDialogTitleText", "Seleccionar archivos a desemcriptar");
            UIManager.put("FileChooser.openButtonText", "Seleccionar archivos a desemcriptar");
        }
        
        UIManager.put("FileChooser.cancelButtonText", "Cancelar");
        UIManager.put("FileChooser.fileNameLabelText", "FileName");
        UIManager.put("FileChooser.filesOfTypeLabelText", "TypeFiles");
        UIManager.put("FileChooser.openButtonToolTipText", "Selecionar archivo");
    ...
    public FileChooser(String encryptOrDecrypt, File[] listOfFilesAndFolders)
    {
        ...
        /* Create and display the form */
        initComponents();
        jFileChooser1.setDialogTitle("Seleccione archivos y aquellas carpetas cuyos archivos desea encriptar "+encryptOrDecrypt);
        jFileChooser1.setMultiSelectionEnabled(true);
        jFileChooser1.setFileSelectionMode(FILES_AND_DIRECTORIES);
        jFileChooser1.setDialogTitle(encryptOrDecrypt);
        if(encryptOrDecrypt.equalsIgnoreCase("encrypt"))
        {
            UIManager.put("FileChooser.openDialogTitleText", "Seleccionar archivos para cifrar");
            UIManager.put("FileChooser.openButtonText", "Seleccionar archivos para cifrar");
        }
        else if(encryptOrDecrypt.equalsIgnoreCase("decrypt"))
        {
            UIManager.put("FileChooser.openDialogTitleText", "Seleccionar archivos para descifrar");
            UIManager.put("FileChooser.openButtonText", "Seleccionar archivos para descifrar");
        }
    ...
    private boolean anyEncFileExists(File[] listOfFilesAndFolders)
    {
        for(File file:listOfFilesAndFolders)
        {
            ...
            {
                System.out.println(file.getAbsoluteFile()+ " Encriptada");
                Toolkit.getDefaultToolkit().beep();
                JOptionPane.showMessageDialog(null, "1 o más archivos no están encriptados !! \nPor favor, selecciónelos.");
                return true;
            } 
        }
        return false;
       ...
       for(File file:listOfFilesAndFolders)
        {
            ...
            if(!file.isDirectory() &&!filePath.substring(filePath.length()-4, filePath.length()).equals(".enc"))
            {
                System.out.println(file.getAbsoluteFile()+ " No encriptada");
                Toolkit.getDefaultToolkit().beep();
                JOptionPane.showMessageDialog(null, "1 o más archivos no están encriptados!! \nPor favor, selecciónelos.");
                return false;
            } 
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(jFileChooser1, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 670, Short.MAX_VALUE)
        );
